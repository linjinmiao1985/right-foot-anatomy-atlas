...
## Coverage by layer (live census 2026-09-15 Day 4ab)
...
- **Skipped after verify**: Open3D med/lat plantar, plantar MTA, dorsal digital, arcuate — BP3D already present; Open3D dorsal digital denser (~2.3× verts) but still grouped and spatially overlaps Day 4aa dorsal MTA → no meaningful per-ray teaching gain; avoid extra BY-SA weight
