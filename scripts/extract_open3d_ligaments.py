#!/usr/bin/env python3
"""Extract RIGHT ankle ligaments / plantar fascia from Open3D lower-limb.obj,
...
Requires: local lower-limb.obj (literature copy or AnatomyTOOL textureless OBJ zip),
numpy, obj2gltf on PATH.
"""
...
def main() -> int:
    ...
    report = ROOT / "third_party/open3dmodel/ligament_extract_aabb.json"
    report.write_text(
        json.dumps(
            {
                "source": str(src),
