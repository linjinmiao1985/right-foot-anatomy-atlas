...
## Day 4ab — Open3D tarsal / calcaneal / perforator vessels (2026-09-15)

- **Pipeline**: same Day 4m Kabsch; `scripts/extract_open3d_vessels.py`
- **QA**: `third_party/open3dmodel/vessel_spatial_qa.json` — all 5 **accept** (inside_padded_frac=1.0; bone AABB overlap; wrong_side=false)
- **Centroids (mm, approx)**: perforating (−112,−132,−42); lat. tarsal (−108,−104,−26); med. tarsal grouped (−72,−124,−29); med. calcaneal (−50,−45,−38); lat. calcaneal (−66,−33,−37)
